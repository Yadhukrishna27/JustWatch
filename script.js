...
b = '  '
movie.forEach((elements,items) => {
    b += `
    <div class="card col-lg-2 col-md-4 col-sm-12 ms-1 mt-3" style="width:18rem;">   
    <img src="${elements.Images}" class="card-img-top mt-4" alt="Sunset Over the Sea"/>
        <div class="card-body">
            <h2 class="card-title">${elements.Title}</h2>
            <h3 class="card-info">${elements.Year}</h3>
            <h4 class="card-desc">${elements.Genre}</h4>
            <button type="button" class=" btn btn-outline-dark" id="mybtn" data-bs-toggle="modal" data-bs-target="#exampleModal-${items}" style="border-radius:50px">
            View more
            </button>
        </div>
    </div> 
    ...
    <!-- Modal -->
    <div class="modal fade" id="exampleModal-${items}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">${elements.Title}</h1>
        </div>
        <div class="modal-body">
            <div class="text-start">
            <h3>Director: <span class="fs-5 ms-2">${elements.Director}</span></h3>
        
            <hr>
                <h3>Plot:</h3>
                <p class="mt-2">${elements.Plot}</p>
            </div>      
        </div>
    </div>
    </div>
    ...
    document.querySelector("#flim").innerHTML = b
});
